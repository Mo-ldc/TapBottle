import { _decorator, Component, Node, Label, Sprite, Tween, UIOpacity, Vec3, tween } from 'cc';
...
export class Hud extends Component {
    ...
    private stamWrap: Node = null!;
    private stamFill: Node = null!;
    ...
    build(cb: {
        ...
        woodButton(this.node, {
            ...
            name: 'btn_back', sound: 'click', onClick: () => cb.onSettings(),
        });
        ...
        for (let i = 0; i < tools.length; i++) {
            ...
            const b = woodButton(this.node, {
                ...
                fill: WOOD.cream, radius: 18, sound: 'click', name: 'tool_' + d.name,
                onClick: d.click,
            });
            if (d.name === 'lang') {
