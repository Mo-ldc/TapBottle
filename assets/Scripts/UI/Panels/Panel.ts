...
import { button, img, label, modalMask, nd, popIn, popOut, roundedPanel, scrollView } from '../Base/UIKit';
...
export function openPanel(parent: Node, titleKey: string, bodyH = BODY_H): PanelWrap {
    ...
    const closeBtn = button(frame, {
        ...
        tex: 'ui/panel/card_white', inset: [26, 26, 26, 26], texColor: '#5C4420',
        sound: 'click', name: 'close', onClick: () => wrap.close(),
    });
    img(closeBtn, 'ui/button/btn_close', 46, 46, 0, 0);
